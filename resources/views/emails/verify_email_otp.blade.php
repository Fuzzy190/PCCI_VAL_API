...
<head>
    ...
    <style>
        ...
        .otp-box { background-color: #F7C6C7; border: 2px dashed #D50032; color: #A50034; font-family: 'Poppins', sans-serif; font-size: 32px; font-weight: 700; letter-spacing: 4px; padding: 20px; margin: 30px auto; border-radius: 8px; max-width: 250px; }
